                        ...
                        <form role="form">
                            <fieldset>
                              <div class="form-group">
                                  <input class="form-control" placeholder="Nom d'utilisateur" name="pseudo" type="text" value="">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <a href="index.php" class="btn btn-lg btn-success btn-block">Inscription</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
